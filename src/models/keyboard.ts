...
export interface IKey {id: number; r: number; g: number; b: number; }
...
export class Keyboard {
    ...
    /**
	    ...
	    */
    public setRgb(key: IKey, r: number, g: number, b: number) {
    ...
    /**
	    ...
	    */
    public setRgbHex(key: IKey, rgb: string | number) {
