...
export const enUS = {
  ...
  Macro3: new KeyModel([45, 48], "Macro3", "M3", {
    x: 86.75,
    y: 1
  }, 3.4, 11.88, 2, 1, 0),
  ...
  altRight: new KeyModel([155], "altRight", "ALT-R", {
    x: 42.80611428,
    y: 75.25
  }, 5.49001714408, 13.5, 1, 0, 2),
  select: new KeyModel([156], "select", "FN", {
    x: 48.03382857,
    y: 75.25
  }, 5.50285714408, 13.5, 1, 0, 2),
